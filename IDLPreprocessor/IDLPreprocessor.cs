...
namespace Ch.Elca.Iiop.IdlPreprocessor {
    ...
    public class IDLPreprocessor {
        ...
        public void Process() {
            ...
            m_fileStream.Close();
            // clear pragma prefix at the end of a file, this is a hack to workaround IIOP.Net bug (https://sourceforge.net/p/iiop-net/bugs/86/)
            m_outputStream.WriteLine("#pragma prefix \"\""); 
